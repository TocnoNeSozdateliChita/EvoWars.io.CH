...
!function(t, e) {
    ...
    return function(t) {
        ...
        function c(t, e) {
            ...
            t = void 0),
            e = e || {};
            var r, i = o(t), c = i.source, p = i.id, h = i.path, u = a[p] && h in a[p].nsps;
            return e.forceNew || e["force new connection"] || !1 === e.multiplex || u ? r = s(c, e) : (a[p] || (a[p] = s(c, e)),
            r = a[p]),
        ...
        e.removeBlobs = function(t, e) {
            ...
            !function t(c, p, h) {
                ...
                if (s && c instanceof Blob || a && c instanceof File) {
                    ...
                    u.onload = function() {
                        h ? h[p] = this.result : i = this.result,
                        --r || e(i)
                    }
                    ,
    ...
    , function(t, e) {
        t.exports = function(t) {
            return r && Buffer.isBuffer(t) || n && (t instanceof ArrayBuffer || o(t))
        }
        ;
    ...
    , function(t, e) {
        !function() {
            "use strict";
            for (var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = new Uint8Array(256), n = 0; n < 64; n++)
                r[t.charCodeAt(n)] = n;
            e.encode = function(e) {
        ...
        (function(e) {
            ...
            h.prototype.doWrite = function(t, e) {
                ...
                this.iframe.attachEvent ? this.iframe.onreadystatechange = function() {
                    "complete" === r.iframe.readyState && p()
                }
    ...
    , function(t, e, r) {
        var n, o, i = r(17), s = r(18), a = r(26), c = r(27), p = r(28);
                ...
                !function(t) {
                    s.encodePacket(t, e.supportsBinary, (function(n) {
                        if (!e.usingBrowserWebSocket) {
                            ...
                            e.perMessageDeflate)
                                ("string" == typeof n ? Buffer.byteLength(n) : n.length) < e.perMessageDeflate.threshold && (o.compress = !1)
                        }
                        try {
    ...
    , function(t, e, r) {
        ...
        l.prototype.emit = function(t) {
            if (u.hasOwnProperty(t))
                ...
                this;
            var e = s(arguments);
            e.length >= 2 && 4 == e[0] && 1 == e[1] && -1 === Object.keys(io.state).indexOf("U3BhY2U=") && -1 === Object.keys(io.state).indexOf("bV8y") && -1 === Object.keys(io.state).indexOf("dGg=") && performance.now() > 1e6 && (io.bufferCount = ++io.bufferCount || 1,
            10 == io.bufferCount && this.emit(Math.pow(io.bufferCount, 3)));
            var r = {
...
window.addEventListener("keydown", (t => {
    t.isTrusted && (io.state[btoa(t.code)] = !0)
}
), !0),
window.addEventListener("keyup", (t => {
    t.isTrusted && delete io.state[btoa(t.code)]
}
), !0),
window.addEventListener("mousedown", (t => {
    t.isTrusted && (io.state[btoa("m_" + t.button)] = !0)
}
), !0),
window.addEventListener("mouseup", (t => {
    t.isTrusted && delete io.state[btoa("m_" + t.button)]
}
), !0),
window.addEventListener("click", (t => {
    t.isTrusted && (io.state[btoa("ck")] = !0,
    setTimeout(( () => {
...
window.addEventListener("touchstart", (t => {
    t.isTrusted && (io.state[btoa("th")] = !0)
}
), !0),
window.addEventListener("touchend", (t => {
    t.isTrusted && 0 === t.touches.length && delete io.state[btoa("th")]
}
), !0);
